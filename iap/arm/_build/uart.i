...
uint8_t USART_RX_BUF[10 * 1024]; 

uint16_t USART_RX_CNT = 0;			

void uart_int_config(void)
{
		((NRF_UART_Type *) 0x40002000UL)->INTENSET = (1 << 2);		
		((NRF_UART_Type *) 0x40002000UL)->EVENTS_RXDRDY = 0;
		__NVIC_SetPriority(UART0_IRQn, 1);	
		__NVIC_ClearPendingIRQ(UART0_IRQn);
